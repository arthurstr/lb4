...
public class GraphicsDisplay extends JPanel {
    ...
    public GraphicsDisplay() {
        ...
        graphicsStroke = new BasicStroke(2.0f, BasicStroke.CAP_BUTT,
                BasicStroke.JOIN_ROUND, 10.0f, new float[]{7,2}, 0.0f);
    ...
    //Целая часть значения функции в точке
    int wholePart(double x) {
        int y = (int) x;
        return y;
    }
    ...
    protected void paintAxis(Graphics2D canvas) {
        ...
        if (minY >= 0.0 && maxY >= 0.0) {
            ...
            canvas.draw(new Line2D.Double(xyToPoint(minX, 5),
                    xyToPoint(maxX, 5)));
            // Стрелка оси X
            GeneralPath arrow = new GeneralPath();
        ...
        Point2D.Double labelPos = xyToPoint(0, 5);
        canvas.drawString("0", (float) (labelPos.getX() - 30), (float) (labelPos.getY())-20);
    }
